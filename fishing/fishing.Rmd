...
- map with permit zones  
- map with areas within the permit zones that do not allow commercial fishing

\  

- all fishing (actual fishing) around Australia of all countries in the past 10 years  
- all fishing (actual fishing) around Australia of all countries in the last full year we have data of (Jan- Dec)   
- single out the top 5 countries fishing around AUS in that year (country by country)      

\  

- blame map showing all individual ships in the last year fishing (actual fishing) within our permit zones  
...
# globe vessel data
globe_top3_2020 <- readRDS(here::here(params$here,"data","top3_2020.Rda"))
globe_all_2020 <- readRDS(here::here(params$here,"data","all_countries_2020.Rda"))
globe_all_aus_eez <- readRDS(here::here(params$here,"data","globe_all_aus_eez.Rda"))
...
### 10 years of fishing around Aus

![](img/globe5.png)   

\  

### Top 3 nations fishing around Aus  
...
### Lu Peng case study  (animated full globe)  
